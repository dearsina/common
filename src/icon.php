...
class icon {
	...
	private static function generate_stacked($stacked){
		...
		$class = str::get_attr("class", "fa-stack");
		$style = str::get_attr("style", "margin:-3px 0px -8px -6px;");
	...
	static function generate($a = NULL){
		...
		if($colour = self::translate_colour($colour)){
			$class[] = " text-{$colour}";
		}

		$title = str::get_attr("title", $alt ?: $title);
		...
		$transform = str::get_attr("data-fa-transform", $transform);
